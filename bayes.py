...
class Search():
    ...
    def draw_map(self, last_known):
        ...
        cv.putText(self.img, '+ = Last Kown Position', (274,355),
                   cv.FONT_HERSHEY_PLAIN, 1, (0,0, 255))
    ...
    def conduct_search(self, area_num, area_array, effectiveness_prob):
        ...
        local_x_range = range(area_array.shape[0])
        local_y_range = range(area_array.shape[1])
...
def draw_menu(search_num):
    ...
    print('\Search {}'.format(search_num))
    print(
        """
...
def main():
    ...
    print("-" * 65)
    print("\nInitital Target (P) Probabilities:")
    ...
    while True:
        ...
        if choice == "0":
            ...
            print("\nSorry, but that isnt a valid choice.", file=sys.stderr)
            continue
